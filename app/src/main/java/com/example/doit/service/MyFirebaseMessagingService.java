...
//        manager.notify(11, createNotification());
    ...
    public static void updateTokenInFirestore(Context context, String token) {
        ...
        CollectionReference notifRequestDBRef = db.collection("notification");
        notifRequestDBRef.whereEqualTo("postedUserId", userId)
                .get()
    ...
    private Notification createNotification() {
        ...
        String NOTIFICATION_CHANNEL_ID = "com.project.service.FCM_Channel";
