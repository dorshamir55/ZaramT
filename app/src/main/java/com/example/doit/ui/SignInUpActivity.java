...
import com.example.doit.model.Utils;
...
public class SignInUpActivity extends AppCompatActivity
    ...
    @Override
    public void onSignUp(String nickname, String email, String password, String repeatPass, Runnable onFinish) {
        if(!Utils.validateCredentials(email, password, repeatPass)) {
